...
class BarangController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        BarangModel::create($request->only(['barang_kode', 'barang_nama', 'kategori_id', 'harga_beli', 'harga_jual']));
    ...
    public function update(Request $request, string $id)
    {
        ...
        BarangModel::find($id)->update($request->only(['barang_kode', 'barang_nama', 'kategori_id', 'harga_beli', 'harga_jual']));
